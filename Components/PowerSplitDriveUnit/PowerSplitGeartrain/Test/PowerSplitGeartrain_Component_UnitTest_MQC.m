classdef PowerSplitGeartrain_Component_UnitTest_MQC < matlab.unittest.TestCase
...
function MQC_run_testcase_Constant(~)
  close all
  bdclose all
  PowerSplitGeartrain_Component_testcase_Constant
  close all
  bdclose all
end

function MQC_run_testcase_Engine(~)
  close all
  bdclose all
  PowerSplitGeartrain_Component_testcase_Engine
  close all
  bdclose all
end

function MQC_run_testcase_MG1(~)
  close all
  bdclose all
  PowerSplitGeartrain_Component_testcase_MG1
  close all
  bdclose all
end

function MQC_run_testcase_MG2(~)
  close all
  bdclose all
  PowerSplitGeartrain_Component_testcase_MG2
  close all
  bdclose all
end

function MQC_run_testcase_VehSpd(~)
  close all
  bdclose all
  PowerSplitGeartrain_Component_testcase_VehSpd
  close all
  bdclose all
end
