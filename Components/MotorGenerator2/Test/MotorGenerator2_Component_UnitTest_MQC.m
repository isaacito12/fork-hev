classdef MotorGenerator2_Component_UnitTest_MQC < matlab.unittest.TestCase
...
function MQC_run_testcase_Constant(~)
  close all
  bdclose all
  MotorGenerator2_Component_testcase_Constant
  close all
  bdclose all
end
...
function MQC_run_testcase_Drive(~)
  close all
  bdclose all
  MotorGenerator2_Component_testcase_Drive
  close all
  bdclose all
end

function MQC_run_testcase_Regen(~)
  close all
  bdclose all
  MotorGenerator2_Component_testcase_Regen
  close all
  bdclose all
end
