classdef MotorGenerator1_Component_UnitTest_MQC < matlab.unittest.TestCase
...
function MQC_run_testcase_Constant(~)
  close all
  bdclose all
  MotorGenerator1_Component_testcase_Constant
  close all
  bdclose all
end

function MQC_run_testcase_Generate(~)
  close all
  bdclose all
  MotorGenerator1_Component_testcase_Generate
  close all
  bdclose all
end

function MQC_run_testcase_StartEngine(~)
  close all
  bdclose all
  MotorGenerator1_Component_testcase_StartEngine
  close all
  bdclose all
end

function MQC_run_testcase_StopEngine(~)
  close all
  bdclose all
  MotorGenerator1_Component_testcase_StopEngine
  close all
  bdclose all
end
